...
class TestCar(unittest.TestCase):
    ...
    def test_add_fuel(self):
        ''' name:chani date:22/01 The function test_add_fuel :return: '''
        try:
            self.car.fuel_up(10)
            ...
            self.log.writeLog({e})
        ''' name:chani  date:22/01 Checking fuel consumption :return: '''
    def test_fuel_consumption(self):
        ...
        ''' name:chani date:22/01  test km update:return: '''
    def test_km_update(self):
        ...
        ''' name:chani date:22/01  test fill up fuel failure :return: '''
    def test_fill_up_fuel_failure(self):
        ...
        ''' name:chani date:22/01 test fill up fuel success :return: '''
    ...
    def test_stop_success(self):
        ...
        '''name:chani date:22/01 test_log_stop_success :return: '''
